...
class AptPlugin49 extends AptPlugin.Impl {
  ...
  protected AptPlugin.AptConvention createAptConvention(
    ...
    return new AptConvention49(project, task, compileOptions);
  }

  @Override
  protected AptPlugin.AptOptions createAptOptions(
      Project project, AbstractCompile task, CompileOptions compileOptions) {
    return new AptOptions49(project, task, compileOptions);
  }
  ...
  private static class AptConvention49 extends AptPlugin.AptConvention {
    private final Project project;
    private final AbstractCompile task;
    private final CompileOptions compileOptions;

    AptConvention49(Project project, AbstractCompile task, CompileOptions compileOptions) {
  ...
  private static class AptOptions49 extends AptPlugin.AptOptions
    ...
    private AptOptions49(Project project, AbstractCompile task, CompileOptions compileOptions) {
      this.project = project;
      this.task = task;
      this.compileOptions = compileOptions;
    }
